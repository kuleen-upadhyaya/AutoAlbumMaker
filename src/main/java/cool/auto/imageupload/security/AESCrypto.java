package cool.auto.imageupload.security;
...
public final class AESCrypto
{
	...
	private static Logger		log					= Logger.getLogger(AESCrypto.class);
	...
	// compatibility)
	private static final byte[]	ivBytes				= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	public static String encrypt(final String password, String message) throws GeneralSecurityException
	{
		...
		try
		{
			...
			log.info("Base64.NO_WRAP : " + encoded);
			return encoded;
		}
	...
	public static String decrypt(final String password, String base64EncodedCipherText) throws GeneralSecurityException
	{
		...
		try
		{
			...
			log.info("base64 Encoded Cipher Text : " + base64EncodedCipherText);

			byte[] decodedCipherText = Base64.decodeBase64(base64EncodedCipherText);
			
			log.info("decoded Cipher Text :" + decodedCipherText);

			byte[] decryptedBytes = decrypt(key, ivBytes, decodedCipherText);

			log.info("decrypted Bytes : " + decryptedBytes);
